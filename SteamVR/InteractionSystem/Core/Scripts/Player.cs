...
{
	//-------------------------------------------------------------------------
	// Singleton representing the local VR vrPlayer/user, with methods for getting
	// the vrPlayer's hands, head, tracking origin, and guesses for various properties.
	//-------------------------------------------------------------------------
	public class Player : MonoBehaviour
	{
		...
		[Tooltip( "Reference to the physics collider that follows the vrPlayer's HMD position." )]
		...
		[Tooltip( "The audio listener for this vrPlayer" )]
		...
		//-------------------------------------------------
		// Height of the eyes above the ground - useful for estimating vrPlayer height.
		//-------------------------------------------------
		...
		//-------------------------------------------------
		// Guess for the world-space position of the vrPlayer's feet, directly beneath the HMD.
		//-------------------------------------------------
		...
		//-------------------------------------------------
		// Guess for the world-space direction of the vrPlayer's hips/torso. This is effectively just the gaze direction projected onto the floor plane.
		//-------------------------------------------------
			...
			get
			{
				...
				if ( hmd )
				{
					...
					if ( Vector3.Dot( hmd.up, trackingOriginTransform.up ) < 0.0f )
					{
						...
						// -The vrPlayer is bending over backwards
						// -The vrPlayer is bent over looking through their legs
						direction = -direction;
					}
					return direction;
				}
